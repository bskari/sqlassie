...
// ----------------------------------------------------------------------------------------
	...
	public:
		...
		conditional_probability_table() : table(), num_vals()
		{
			clear();
		}
...
// ------------------------------------------------------------------------
	...
	{
	public:
		bayes_node () : value_(), is_instantiated(), table_()
		{
...
// ----------------------------------------------------------------------------------------
	...
	public:
		...
		bayesian_network_gibbs_sampler () : v(), rnd(), samples()
		{
