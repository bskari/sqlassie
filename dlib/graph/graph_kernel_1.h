...
// ----------------------------------------------------------------------------------------
	...
	)
	{
		...
		if (node_index1 != node_index2)
		{
			...
			unsigned long pos_local = static_cast<unsigned long>(find(n2.neighbors.begin(), n2.neighbors.end(), &n1) - n2.neighbors.begin());
			n2.neighbors.erase(n2.neighbors.begin() + pos_local);
			n2.edges.erase(n2.edges.begin() + pos_local); 
		}
	}
