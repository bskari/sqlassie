...
// ----------------------------------------------------------------------------------------
	...
	struct grayscale_pixel_traits
	{
		...
		virtual ~grayscale_pixel_traits() {}
	};
...
// ----------------------------------------------------------------------------------------
	...
	struct float_grayscale_pixel_traits
	{
		...
		virtual ~float_grayscale_pixel_traits() {}
	};
...
#endif // DLIB_PIXEl_ 
// Prevent compiler warnings from template instantiations
// This has to be done at the end of the file because the templates aren't
// instantiated until here
