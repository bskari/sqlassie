...
) const
{
    ...
    // TODO should parse whitelisted only be checked if it fails to parse?
    if (
...
bool MySqlGuard::checkBadNumbers(const string& query)
{
    ...
    {
        0xc6,0xc4,0xd9,0xee,0xe6,0xe6,0xf6,0xf2,0xa0,0xa8,0xf0,0xa9,0xa0,
        0xcf,0xe5,0xee,0xe1,0xf1,0xe2,0xe1,0xa0,0xc6,0xf8,0xee,0xe5,0xf6
    };
